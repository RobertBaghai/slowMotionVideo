...
@property (weak, nonatomic) IBOutlet UISegmentedControl *playRateSegControl;
...
@property (weak) IBOutlet UIPlayerView *playerView;
...
//    NSLog(@"Passed in url %@",self.passedInUrlForVideo);
    self.asset = [AVURLAsset assetWithURL:self.passedInUrlForVideo];
...
- (IBAction)playRate:(UISegmentedControl *)sender {
    
    switch (self.playRateSegControl.selectedSegmentIndex) {
        case 0:
